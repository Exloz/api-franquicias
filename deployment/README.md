...
- Cuenta AWS `000000000000` autenticada sin access keys estáticas.
- Región `us-east-1`.
- Bucket `franchise-000000000000-terraform-state` creado por `terraform/bootstrap/`.
- Rol `arn:aws:iam::000000000000:role/franchise-terraform-apply` asumido por el operador.
