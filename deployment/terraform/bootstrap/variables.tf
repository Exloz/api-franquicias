variable "state_bucket_name" {
  ...
  type        = string
  default     = "franchise-000000000000-terraform-state"

  validation {
    condition     = var.state_bucket_name == "franchise-000000000000-terraform-state"
    error_message = "The bootstrap state bucket must be franchise-000000000000-terraform-state."
  }
}
...
variable "bootstrap_principal_arn" {
  ...
  type        = string
  default     = "arn:aws:iam::000000000000:user/franchise-admin-1"

  validation {
    condition     = var.bootstrap_principal_arn == "arn:aws:iam::000000000000:user/franchise-admin-1"
