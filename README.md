...
|---|---|---|
| DEV | `https://example-dev.execute-api.us-east-1.amazonaws.com` | `https://example-dev.execute-api.us-east-1.amazonaws.com/actuator/health/readiness` |
| PROD | `https://example-prod.execute-api.us-east-1.amazonaws.com` | `https://example-prod.execute-api.us-east-1.amazonaws.com/actuator/health/readiness` |
