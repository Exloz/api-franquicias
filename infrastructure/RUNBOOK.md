...
- Cuenta: `000000000000`.
- Región: `us-east-1`.
- Endpoint público: `https://example-dev.execute-api.us-east-1.amazonaws.com`.
- Terraform root: `infrastructure/environments/dev`.
- Estado remoto: `s3://franchise-000000000000-terraform-state/dev/infrastructure.tfstate`.
...
credentials="$(aws sts assume-role \
  --role-arn arn:aws:iam::000000000000:role/franchise-terraform-apply \
