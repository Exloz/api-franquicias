locals {
  ...
  runtime_permissions_boundary_arn = "arn:aws:iam::000000000000:policy/franchise-runtime-permissions-boundary"
  ci_permissions_boundary_arn      = "arn:aws:iam::000000000000:policy/franchise-boundary-ci"
  tags = merge(var.tags, {
...
module "ci_identity" {
  ...
  state_bucket_name          = "franchise-000000000000-terraform-state"
  environments = {
    dev = {
      state_key                  = "dev/infrastructure.tfstate"
      infrastructure_name_prefix = "franchise-dev"
      ecr_pull_repository_arns = [
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-dev-api",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-dev-migrations",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-dev-bootstrap"
      ]
      ...
      ecs_pass_role_arns = [
        "arn:aws:iam::000000000000:role/franchise-dev-api-execution",
        "arn:aws:iam::000000000000:role/franchise-dev-api-task",
        "arn:aws:iam::000000000000:role/franchise-dev-migration-execution",
        "arn:aws:iam::000000000000:role/franchise-dev-migration-task",
        "arn:aws:iam::000000000000:role/franchise-dev-database-bootstrap-execution",
        "arn:aws:iam::000000000000:role/franchise-dev-database-bootstrap-task"
      ]
    }
    prod = {
      ...
      ecr_pull_repository_arns = [
        ...
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-dev-migrations",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-dev-bootstrap",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-prod-api",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-prod-migrations",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-prod-bootstrap"
      ]
      ecr_push_repository_arns = [
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-prod-api",
        "arn:aws:ecr:us-east-1:000000000000:repository/franchise-prod-migrations",
      ...
      ecs_pass_role_arns = [
        "arn:aws:iam::000000000000:role/franchise-prod-api-execution",
        "arn:aws:iam::000000000000:role/franchise-prod-api-task",
        "arn:aws:iam::000000000000:role/franchise-prod-migration-execution",
        "arn:aws:iam::000000000000:role/franchise-prod-migration-task",
        "arn:aws:iam::000000000000:role/franchise-prod-database-bootstrap-execution",
        "arn:aws:iam::000000000000:role/franchise-prod-database-bootstrap-task"
      ]
    }
  }
