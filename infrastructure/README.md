...
- AWS account `000000000000` authenticated without static access keys.
- State bucket `franchise-000000000000-terraform-state` provisioned from `bootstrap/`.
- Role `arn:aws:iam::000000000000:role/franchise-terraform-apply` available for the human operator to assume outside Terraform.
